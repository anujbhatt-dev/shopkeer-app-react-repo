...
<React.Fragment>
            <table className="products__table">
                ...
                {this.props.products.map((product,index)=><MyProductTableRow index={index} deleteProduct={this.props.deleteProduct} priceChange={this.props.priceChange} index={index} product={product} checkBoxClick={this.props.checkBoxClick} inputChange={this.props.inputChange}/>)}
                </tbody>
